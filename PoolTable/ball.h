...
public:
    ...
    Ball(Ball const &other)
        : m_position(other.position()),m_velocity(other.velocity()),m_radius(other.radius()),m_mass(other.mass()),m_colour(other.colour())
    {}
    ...
    virtual QColor colour() const {return m_colour;}
    ...
    /**
     * @brief isComposite
     * @return true if ball is composite. Need for deep copy of the ball
     */
    virtual bool isComposite() { return false; }

    /**
     * @brief balls
     * @return all the child balls for composite Balls
     *          Does nothing for other. Needed for deep copy
     */
    virtual std::vector<Ball*> balls() const { }
